...
\newpage
	\subsection{Curb Extensions}
		...
		\todo[inline]{Nakul: Add the curb extensions section}
...
\section{Analysis}
	\subsection{Methodology}\todo[inline]{Talk about the methodology we used}
	\subsection{Rankings}\todo[inline]{Rank the practices}
	\subsection{Discussion}\todo[inline]{Discuss the results}

\section{Conclusion}\todo[inline]{Conclude}
...
\todo[inline]{John: Add your resume to the resumes subfolder}
